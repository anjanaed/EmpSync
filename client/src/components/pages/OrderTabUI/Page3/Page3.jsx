...
const translations = {
  ...
  sinhala: {
    ...
    orderFailed:
      "ඔබේ ඇණවුම ඉදිරිපත් කිරීමට අසමත් විය. කරුණාකර නැවත උත්සාහ කරන්න.",
  ...
  tamil: {
    ...
    orderFailed:
      "உங்கள் ஆர்டரை சமர்ப்பிக்க முடியவில்லை. தயவுசெய்து மீண்டும் முயற்சிக்கவும்.",
    ...
    <Layout className={styles.layout}>
      <div className={styles.header}>
        ...
        <div className={styles.userName}>
          ...
          {/* Display "Guest" if username is empty */}
        </div>
      </div>
                ...
                <div style={{ marginBottom: 24 }}>
                  <Space.Compact className={styles.dateButtonGroup}>
                    <Button
                      ...
                      style={{
                        backgroundColor:
                          selectedDate === "today" ? "#ff4d4f" : "#f0f0f0", // Red for selected, light gray for default
                        color: selectedDate === "today" ? "#fff" : "#000", // White text for selected, black for default
                        borderColor:
                          selectedDate === "today" ? "#d9363e" : "#d9d9d9", // Darker red border for selected
                      }}
                    >
                    ...
                    <Button
                      ...
                      style={{
                        backgroundColor:
                          selectedDate === "tomorrow" ? "#ff4d4f" : "#f0f0f0", // Red for selected, light gray for default
                        color: selectedDate === "tomorrow" ? "#fff" : "#000", // White text for selected, black for default
                        borderColor:
                          selectedDate === "tomorrow" ? "#d9363e" : "#d9d9d9", // Darker red border for selected
                                  ...
                                  cover={
                                    <img
                                      ...
                                      style={{
                                        ...
                                        filter: isPastDue
                                          ? "grayscale(100%)"
                                          : "none", // Gray out the image if past due
                                      }}
                                    />
                                  }
                                  style={{
                                    cursor: isPastDue
                                      ? "not-allowed"
                                      : "pointer", // Change cursor if past due
                                        ...
                                        <Button
                                          ...
                                          style={{
                                            ...
                                            backgroundColor: isPastDue
                                              ? "#d9d9d9"
                                              : "#ff4d4f", // Gray for disabled, red for enabled
                                            color: isPastDue
                                              ? "#8c8c8c"
                                              : "#fff", // Light gray text for disabled, white for enabled
                                            borderColor: isPastDue
                                              ? "#d9d9d9"
                                              : "#d9363e", // Gray border for disabled, darker red for enabled
                                            cursor: isPastDue
                                              ? "not-allowed"
                                              : "pointer", // Change cursor for disabled state
                                          }}
                ...
                <div className={styles.orderSummaryContainer}>
                  ...
                  <Button
                    ...
                    style={{
                      ...
                      height: 70,
                      backgroundColor:
                        orderItems.length === 0 ? "#d9d9d9" : "#ff4d4f", // Gray for disabled, red for enabled
                      color: orderItems.length === 0 ? "#8c8c8c" : "#fff", // Light gray text for disabled, white for enabled
                      borderColor:
                        orderItems.length === 0 ? "#d9d9d9" : "#d9363e", // Gray border for disabled, darker red for enabled
                      cursor:
                        orderItems.length === 0 ? "not-allowed" : "pointer", // Change cursor for disabled state
                    }}
                  >
                    {text.placeOrder}
                  </Button>
