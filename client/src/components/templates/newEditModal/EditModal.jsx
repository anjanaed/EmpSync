...
const EditModal = ({ empId, fetchEmployee }) => {
                    ...
                    <div className={styles.con}>
                      ...
                      >
                        <Select
                          ...
                          onChange={(value) =>
                            setCurrentEmployee({ ...currentEmployee, gender: value })
                          }
                    ...
                    <div className={styles.con}>
                      ...
                      >
                        <Select
                          ...
                          onChange={(value) =>
                            setCurrentEmployee({ ...currentEmployee, language: value })
                          }
                        >
                      ...
                      <label className={styles.fingerLabel}>Finger Print: </label>
                      <button className={styles.rescanBtn}><RiFingerprintLine  size={20}/> &nbsp;Rescan</button>
                    </div>
                    <div className={styles.subBtn}>
                    <Gbutton onClick={handleUpdate}><><LuSave size={16}/>&nbsp;&nbsp;Save Changes</></Gbutton>
                    </div>
