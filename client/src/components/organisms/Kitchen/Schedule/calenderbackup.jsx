    ...
    <div className={styles.container}>
            ...
            {selectedMeals.includes("lunch") && (
              <Button
                ...
                className={`${styles.toggleTimeBtn} ${
                  !showTimePickers.lunch ? styles.showTimeBtn : ""
                }`}
              >
          ...
          <div className={styles.mealItems}>
            ...
            {selectedMeals.includes("dinner") && (
              <Button
                ...
                className={`${styles.toggleTimeBtn} ${
                  !showTimePickers.dinner ? styles.showTimeBtn : ""
                }`}
              >
            ...
            <div key={mealId} className={styles.mealItems}>
              ...
              {selectedMeals.includes(mealId) && (
                <Button
                  ...
                  className={`${styles.toggleTimeBtn} ${
                    !showTimePickers[mealId] ? styles.showTimeBtn : ""
                  }`}
                >
      ...
      <div className={styles.contentArea}>
        ...
        >
          ...
          {Object.entries(customMeals).map(
            ([mealId, mealDetails]) =>
              selectedMeals.includes(mealId) && (
                <TabPane
                  tab={mealDetails.name}
                  key={mealId}
