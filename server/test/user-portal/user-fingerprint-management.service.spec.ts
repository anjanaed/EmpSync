...
import { HrFingerprintsController } from '../../src/modules/hr-fingerprints/hr-fingerprints.controller';
import { HrFingerprintsService } from '../../src/modules/hr-fingerprints/hr-fingerprints.service';
import { UserFingerPrintRegisterBackendController } from '../../src/modules/user-finger-print-register-backend/user-finger-print-register-backend.controller';
import { UserFingerPrintRegisterBackendService } from '../../src/modules/user-finger-print-register-backend/user-finger-print-register-backend.service';
...
describe('User Portal - Fingerprint Management Service', () => {
  ...
  describe('Test Case 17: Search Specific User Fingerprint', () => {
    ...
    it('should return not found for non-existent thumb ID', async () => {
      ...
      // Act
      const result = await userFingerprintController.getFingerprintByThumbid(nonExistentThumbId);
